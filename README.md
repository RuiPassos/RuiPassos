...
| **[Rental & Utility App](https://github.com/RuiPassos/Rental-Utility-Manager)** | .NET MAUI, SQL | Automated utility billing with custom algorithms for property management. |
